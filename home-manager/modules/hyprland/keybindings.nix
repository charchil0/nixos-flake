{ ... }: {
  ...
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      ...
      "$mainMod+Shift, T, exec, $HOME/.config/hypr/touchpad.sh"
      ...
      "$mainMod, Tab, exec, pkill -x rofi || rofi -show window -modi window"
      "$mainMod+Shift, E, exec, pkill -x rofi || rofi -show filebrowser -modi filebrowser"
      ...
      "$mainMod, T, exec, pkill -x rofi || $scrPath/themeselect.sh"
